...
translateBtn.addEventListener("click", () => {
       ...
       // fetching api response and returning itwith parsing into js obj
...
// if clicked icon has from id, copy the from Textarea value else copy the toTextarea value
            if(target.id == "from"){
            ...
            let utterance;
// if clicked icon has fromid, speak the fromTextarea value else speak the toTextarea value
            if(target.id == "from"){
